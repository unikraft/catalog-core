...
./setup.sh
test -d ./scripts/test/log || mkdir -p ./scripts/test/log
test_build_run_http qemu.x86_64 localhost 8080
test_build_run_http qemu.arm64 localhost 18080
test_build_run_console fc.x86_64
test_build fc.arm64

...
UK_SYSCALL_EXECENV_PROLOGUE_DEFINE(uk_syscall6_do, uk_syscall6_do_e,
...
long __used uk_syscall6_do_e(struct ukarch_execenv *execenv)
{
	...
	case SYS_close:
		...
		ret = uk_syscall_do_e_close((long)execenv);
#else /* !HAVE_uk_syscall_e_close */
		ret = uk_syscall_do_close(
	...
	case SYS_dup:
		...
		ret = uk_syscall_do_e_dup((long)execenv);
#else /* !HAVE_uk_syscall_e_dup */
		ret = uk_syscall_do_dup(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_dup3:
		...
		ret = uk_syscall_do_e_dup3((long)execenv);
#else /* !HAVE_uk_syscall_e_dup3 */
		ret = uk_syscall_do_dup3(
	...
	case SYS_dup2:
		...
		ret = uk_syscall_do_e_dup2((long)execenv);
#else /* !HAVE_uk_syscall_e_dup2 */
		ret = uk_syscall_do_dup2(
	...
	case SYS_preadv2:
		...
		ret = uk_syscall_do_e_preadv2((long)execenv);
#else /* !HAVE_uk_syscall_e_preadv2 */
		ret = uk_syscall_do_preadv2(
	...
	case SYS_preadv:
		...
		ret = uk_syscall_do_e_preadv((long)execenv);
#else /* !HAVE_uk_syscall_e_preadv */
		ret = uk_syscall_do_preadv(
	...
	case SYS_pread64:
		...
		ret = uk_syscall_do_e_pread64((long)execenv);
#else /* !HAVE_uk_syscall_e_pread64 */
		ret = uk_syscall_do_pread64(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_readv:
		...
		ret = uk_syscall_do_e_readv((long)execenv);
#else /* !HAVE_uk_syscall_e_readv */
		ret = uk_syscall_do_readv(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_read:
		...
		ret = uk_syscall_do_e_read((long)execenv);
#else /* !HAVE_uk_syscall_e_read */
		ret = uk_syscall_do_read(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_pwritev2:
		...
		ret = uk_syscall_do_e_pwritev2((long)execenv);
#else /* !HAVE_uk_syscall_e_pwritev2 */
		ret = uk_syscall_do_pwritev2(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_pwritev:
		...
		ret = uk_syscall_do_e_pwritev((long)execenv);
#else /* !HAVE_uk_syscall_e_pwritev */
		ret = uk_syscall_do_pwritev(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_pwrite64:
		...
		ret = uk_syscall_do_e_pwrite64((long)execenv);
#else /* !HAVE_uk_syscall_e_pwrite64 */
		ret = uk_syscall_do_pwrite64(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_writev:
		...
		ret = uk_syscall_do_e_writev((long)execenv);
#else /* !HAVE_uk_syscall_e_writev */
		ret = uk_syscall_do_writev(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_write:
		...
		ret = uk_syscall_do_e_write((long)execenv);
#else /* !HAVE_uk_syscall_e_write */
		ret = uk_syscall_do_write(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_lseek:
		...
		ret = uk_syscall_do_e_lseek((long)execenv);
#else /* !HAVE_uk_syscall_e_lseek */
		ret = uk_syscall_do_lseek(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_fstat:
		...
		ret = uk_syscall_do_e_fstat((long)execenv);
#else /* !HAVE_uk_syscall_e_fstat */
		ret = uk_syscall_do_fstat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_fchmod:
		...
		ret = uk_syscall_do_e_fchmod((long)execenv);
#else /* !HAVE_uk_syscall_e_fchmod */
		ret = uk_syscall_do_fchmod(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_fchown:
		...
		ret = uk_syscall_do_e_fchown((long)execenv);
#else /* !HAVE_uk_syscall_e_fchown */
		ret = uk_syscall_do_fchown(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_fsync:
		...
		ret = uk_syscall_do_e_fsync((long)execenv);
#else /* !HAVE_uk_syscall_e_fsync */
		ret = uk_syscall_do_fsync(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_fdatasync:
		...
		ret = uk_syscall_do_e_fdatasync((long)execenv);
#else /* !HAVE_uk_syscall_e_fdatasync */
		ret = uk_syscall_do_fdatasync(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_ftruncate:
		...
		ret = uk_syscall_do_e_ftruncate((long)execenv);
#else /* !HAVE_uk_syscall_e_ftruncate */
		ret = uk_syscall_do_ftruncate(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_fallocate:
		...
		ret = uk_syscall_do_e_fallocate((long)execenv);
#else /* !HAVE_uk_syscall_e_fallocate */
		ret = uk_syscall_do_fallocate(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_fadvise64:
		...
		ret = uk_syscall_do_e_fadvise64((long)execenv);
#else /* !HAVE_uk_syscall_e_fadvise64 */
		ret = uk_syscall_do_fadvise64(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_fcntl:
		...
		ret = uk_syscall_do_e_fcntl((long)execenv);
#else /* !HAVE_uk_syscall_e_fcntl */
		ret = uk_syscall_do_fcntl(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_ioctl:
		...
		ret = uk_syscall_do_e_ioctl((long)execenv);
#else /* !HAVE_uk_syscall_e_ioctl */
		ret = uk_syscall_do_ioctl(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
...
#ifdef HAVE_uk_syscall_e_eventfd
		ret = uk_syscall_do_e_eventfd((long)execenv);
#else /* !HAVE_uk_syscall_e_eventfd */
		ret = uk_syscall_do_eventfd(
					execenv->regs.__syscall_rarg0);

#endif /* !HAVE_uk_syscall_e_eventfd */
...
#ifdef HAVE_uk_syscall_e_eventfd2
		ret = uk_syscall_do_e_eventfd2((long)execenv);
#else /* !HAVE_uk_syscall_e_eventfd2 */
		ret = uk_syscall_do_eventfd2(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_pipe:
		...
		ret = uk_syscall_do_e_pipe((long)execenv);
#else /* !HAVE_uk_syscall_e_pipe */
		ret = uk_syscall_do_pipe(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_pipe2:
		...
		ret = uk_syscall_do_e_pipe2((long)execenv);
#else /* !HAVE_uk_syscall_e_pipe2 */
		ret = uk_syscall_do_pipe2(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_poll:
		...
		ret = uk_syscall_do_e_poll((long)execenv);
#else /* !HAVE_uk_syscall_e_poll */
		ret = uk_syscall_do_poll(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_ppoll:
		...
		ret = uk_syscall_do_e_ppoll((long)execenv);
#else /* !HAVE_uk_syscall_e_ppoll */
		ret = uk_syscall_do_ppoll(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_select:
		...
		ret = uk_syscall_do_e_select((long)execenv);
#else /* !HAVE_uk_syscall_e_select */
		ret = uk_syscall_do_select(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_pselect6:
		...
		ret = uk_syscall_do_e_pselect6((long)execenv);
#else /* !HAVE_uk_syscall_e_pselect6 */
		ret = uk_syscall_do_pselect6(
	...
	case SYS_epoll_create:
		...
		ret = uk_syscall_do_e_epoll_create((long)execenv);
#else /* !HAVE_uk_syscall_e_epoll_create */
		ret = uk_syscall_do_epoll_create(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_epoll_create1:
		...
		ret = uk_syscall_do_e_epoll_create1((long)execenv);
#else /* !HAVE_uk_syscall_e_epoll_create1 */
		ret = uk_syscall_do_epoll_create1(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_epoll_ctl:
		...
		ret = uk_syscall_do_e_epoll_ctl((long)execenv);
#else /* !HAVE_uk_syscall_e_epoll_ctl */
		ret = uk_syscall_do_epoll_ctl(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_epoll_wait:
		...
		ret = uk_syscall_do_e_epoll_wait((long)execenv);
#else /* !HAVE_uk_syscall_e_epoll_wait */
		ret = uk_syscall_do_epoll_wait(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_epoll_pwait:
		...
		ret = uk_syscall_do_e_epoll_pwait((long)execenv);
#else /* !HAVE_uk_syscall_e_epoll_pwait */
		ret = uk_syscall_do_epoll_pwait(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4, execenv->regs.__syscall_rarg5);
	...
	case SYS_epoll_pwait2:
		...
		ret = uk_syscall_do_e_epoll_pwait2((long)execenv);
#else /* !HAVE_uk_syscall_e_epoll_pwait2 */
		ret = uk_syscall_do_epoll_pwait2(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4, execenv->regs.__syscall_rarg5);
	...
	case SYS_alarm:
		...
		ret = uk_syscall_do_e_alarm((long)execenv);
#else /* !HAVE_uk_syscall_e_alarm */
		ret = uk_syscall_do_alarm(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_clone:
		...
		ret = uk_syscall_do_e_clone((long)execenv);
#else /* !HAVE_uk_syscall_e_clone */
		ret = uk_syscall_do_clone(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_pause:
		...
		ret = uk_syscall_do_e_pause((long)execenv);
#else /* !HAVE_uk_syscall_e_pause */
		ret = uk_syscall_do_pause(
					);
	...
	case SYS_sigaltstack:
		...
		ret = uk_syscall_do_e_sigaltstack((long)execenv);
#else /* !HAVE_uk_syscall_e_sigaltstack */
		ret = uk_syscall_do_sigaltstack(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_rt_sigpending:
		...
		ret = uk_syscall_do_e_rt_sigpending((long)execenv);
#else /* !HAVE_uk_syscall_e_rt_sigpending */
		ret = uk_syscall_do_rt_sigpending(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_rt_sigprocmask:
		...
		ret = uk_syscall_do_e_rt_sigprocmask((long)execenv);
#else /* !HAVE_uk_syscall_e_rt_sigprocmask */
		ret = uk_syscall_do_rt_sigprocmask(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_rt_sigsuspend:
		...
		ret = uk_syscall_do_e_rt_sigsuspend((long)execenv);
#else /* !HAVE_uk_syscall_e_rt_sigsuspend */
		ret = uk_syscall_do_rt_sigsuspend(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_rt_sigaction:
		...
		ret = uk_syscall_do_e_rt_sigaction((long)execenv);
#else /* !HAVE_uk_syscall_e_rt_sigaction */
		ret = uk_syscall_do_rt_sigaction(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_rt_sigqueueinfo:
		...
		ret = uk_syscall_do_e_rt_sigqueueinfo((long)execenv);
#else /* !HAVE_uk_syscall_e_rt_sigqueueinfo */
		ret = uk_syscall_do_rt_sigqueueinfo(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_rt_tgsigqueueinfo:
		...
		ret = uk_syscall_do_e_rt_tgsigqueueinfo((long)execenv);
#else /* !HAVE_uk_syscall_e_rt_tgsigqueueinfo */
		ret = uk_syscall_do_rt_tgsigqueueinfo(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_rt_sigtimedwait:
		...
		ret = uk_syscall_do_e_rt_sigtimedwait((long)execenv);
#else /* !HAVE_uk_syscall_e_rt_sigtimedwait */
		ret = uk_syscall_do_rt_sigtimedwait(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_kill:
		...
		ret = uk_syscall_do_e_kill((long)execenv);
#else /* !HAVE_uk_syscall_e_kill */
		ret = uk_syscall_do_kill(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_tgkill:
		...
		ret = uk_syscall_do_e_tgkill((long)execenv);
#else /* !HAVE_uk_syscall_e_tgkill */
		ret = uk_syscall_do_tgkill(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_tkill:
		...
		ret = uk_syscall_do_e_tkill((long)execenv);
#else /* !HAVE_uk_syscall_e_tkill */
		ret = uk_syscall_do_tkill(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_wait4:
		...
		ret = uk_syscall_do_e_wait4((long)execenv);
#else /* !HAVE_uk_syscall_e_wait4 */
		ret = uk_syscall_do_wait4(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_waitid:
		...
		ret = uk_syscall_do_e_waitid((long)execenv);
#else /* !HAVE_uk_syscall_e_waitid */
		ret = uk_syscall_do_waitid(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_getpgid:
		...
		ret = uk_syscall_do_e_getpgid((long)execenv);
#else /* !HAVE_uk_syscall_e_getpgid */
		ret = uk_syscall_do_getpgid(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_setpgid:
		...
		ret = uk_syscall_do_e_setpgid((long)execenv);
#else /* !HAVE_uk_syscall_e_setpgid */
		ret = uk_syscall_do_setpgid(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_setsid:
		...
		ret = uk_syscall_do_e_setsid((long)execenv);
#else /* !HAVE_uk_syscall_e_setsid */
		ret = uk_syscall_do_setsid(
					);
	...
	case SYS_getsid:
		...
		ret = uk_syscall_do_e_getsid((long)execenv);
#else /* !HAVE_uk_syscall_e_getsid */
		ret = uk_syscall_do_getsid(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_setpriority:
		...
		ret = uk_syscall_do_e_setpriority((long)execenv);
#else /* !HAVE_uk_syscall_e_setpriority */
		ret = uk_syscall_do_setpriority(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_getpriority:
		...
		ret = uk_syscall_do_e_getpriority((long)execenv);
#else /* !HAVE_uk_syscall_e_getpriority */
		ret = uk_syscall_do_getpriority(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_getpgrp:
		...
		ret = uk_syscall_do_e_getpgrp((long)execenv);
#else /* !HAVE_uk_syscall_e_getpgrp */
		ret = uk_syscall_do_getpgrp(
					);
	...
	case SYS_getpid:
		...
		ret = uk_syscall_do_e_getpid((long)execenv);
#else /* !HAVE_uk_syscall_e_getpid */
		ret = uk_syscall_do_getpid(
					);
	...
	case SYS_gettid:
		...
		ret = uk_syscall_do_e_gettid((long)execenv);
#else /* !HAVE_uk_syscall_e_gettid */
		ret = uk_syscall_do_gettid(
					);
	...
	case SYS_getppid:
		...
		ret = uk_syscall_do_e_getppid((long)execenv);
#else /* !HAVE_uk_syscall_e_getppid */
		ret = uk_syscall_do_getppid(
					);
	...
	case SYS_prlimit64:
		...
		ret = uk_syscall_do_e_prlimit64((long)execenv);
#else /* !HAVE_uk_syscall_e_prlimit64 */
		ret = uk_syscall_do_prlimit64(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_getrlimit:
		...
		ret = uk_syscall_do_e_getrlimit((long)execenv);
#else /* !HAVE_uk_syscall_e_getrlimit */
		ret = uk_syscall_do_getrlimit(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_setrlimit:
		...
		ret = uk_syscall_do_e_setrlimit((long)execenv);
#else /* !HAVE_uk_syscall_e_setrlimit */
		ret = uk_syscall_do_setrlimit(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_getrusage:
		...
		ret = uk_syscall_do_e_getrusage((long)execenv);
#else /* !HAVE_uk_syscall_e_getrusage */
		ret = uk_syscall_do_getrusage(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_prctl:
		...
		ret = uk_syscall_do_e_prctl((long)execenv);
#else /* !HAVE_uk_syscall_e_prctl */
		ret = uk_syscall_do_prctl(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_exit:
		...
		ret = uk_syscall_do_e_exit((long)execenv);
#else /* !HAVE_uk_syscall_e_exit */
		ret = uk_syscall_do_exit(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_exit_group:
		...
		ret = uk_syscall_do_e_exit_group((long)execenv);
#else /* !HAVE_uk_syscall_e_exit_group */
		ret = uk_syscall_do_exit_group(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_socket:
		...
		ret = uk_syscall_do_e_socket((long)execenv);
#else /* !HAVE_uk_syscall_e_socket */
		ret = uk_syscall_do_socket(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_accept:
		...
		ret = uk_syscall_do_e_accept((long)execenv);
#else /* !HAVE_uk_syscall_e_accept */
		ret = uk_syscall_do_accept(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_accept4:
		...
		ret = uk_syscall_do_e_accept4((long)execenv);
#else /* !HAVE_uk_syscall_e_accept4 */
		ret = uk_syscall_do_accept4(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_getsockopt:
		...
		ret = uk_syscall_do_e_getsockopt((long)execenv);
#else /* !HAVE_uk_syscall_e_getsockopt */
		ret = uk_syscall_do_getsockopt(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_setsockopt:
		...
		ret = uk_syscall_do_e_setsockopt((long)execenv);
#else /* !HAVE_uk_syscall_e_setsockopt */
		ret = uk_syscall_do_setsockopt(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_bind:
		...
		ret = uk_syscall_do_e_bind((long)execenv);
#else /* !HAVE_uk_syscall_e_bind */
		ret = uk_syscall_do_bind(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_listen:
		...
		ret = uk_syscall_do_e_listen((long)execenv);
#else /* !HAVE_uk_syscall_e_listen */
		ret = uk_syscall_do_listen(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_connect:
		...
		ret = uk_syscall_do_e_connect((long)execenv);
#else /* !HAVE_uk_syscall_e_connect */
		ret = uk_syscall_do_connect(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_getpeername:
		...
		ret = uk_syscall_do_e_getpeername((long)execenv);
#else /* !HAVE_uk_syscall_e_getpeername */
		ret = uk_syscall_do_getpeername(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_getsockname:
		...
		ret = uk_syscall_do_e_getsockname((long)execenv);
#else /* !HAVE_uk_syscall_e_getsockname */
		ret = uk_syscall_do_getsockname(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_recvfrom:
		...
		ret = uk_syscall_do_e_recvfrom((long)execenv);
#else /* !HAVE_uk_syscall_e_recvfrom */
		ret = uk_syscall_do_recvfrom(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4, execenv->regs.__syscall_rarg5);
	...
	case SYS_recvmsg:
		...
		ret = uk_syscall_do_e_recvmsg((long)execenv);
#else /* !HAVE_uk_syscall_e_recvmsg */
		ret = uk_syscall_do_recvmsg(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_sendto:
		...
		ret = uk_syscall_do_e_sendto((long)execenv);
#else /* !HAVE_uk_syscall_e_sendto */
		ret = uk_syscall_do_sendto(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4, execenv->regs.__syscall_rarg5);
	...
	case SYS_sendmsg:
		...
		ret = uk_syscall_do_e_sendmsg((long)execenv);
#else /* !HAVE_uk_syscall_e_sendmsg */
		ret = uk_syscall_do_sendmsg(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_socketpair:
		...
		ret = uk_syscall_do_e_socketpair((long)execenv);
#else /* !HAVE_uk_syscall_e_socketpair */
		ret = uk_syscall_do_socketpair(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_shutdown:
		...
		ret = uk_syscall_do_e_shutdown((long)execenv);
#else /* !HAVE_uk_syscall_e_shutdown */
		ret = uk_syscall_do_shutdown(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
...
#ifdef HAVE_uk_syscall_e_sysinfo
		ret = uk_syscall_do_e_sysinfo((long)execenv);
#else /* !HAVE_uk_syscall_e_sysinfo */
		ret = uk_syscall_do_sysinfo(
					execenv->regs.__syscall_rarg0);
...
#ifdef HAVE_uk_syscall_e_uname
		ret = uk_syscall_do_e_uname((long)execenv);
#else /* !HAVE_uk_syscall_e_uname */
		ret = uk_syscall_do_uname(
					execenv->regs.__syscall_rarg0);
...
#ifdef HAVE_uk_syscall_e_sethostname
		ret = uk_syscall_do_e_sethostname((long)execenv);
#else /* !HAVE_uk_syscall_e_sethostname */
		ret = uk_syscall_do_sethostname(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
...
#ifdef HAVE_uk_syscall_e_getcpu
		ret = uk_syscall_do_e_getcpu((long)execenv);
#else /* !HAVE_uk_syscall_e_getcpu */
		ret = uk_syscall_do_getcpu(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_futex:
		...
		ret = uk_syscall_do_e_futex((long)execenv);
#else /* !HAVE_uk_syscall_e_futex */
		ret = uk_syscall_do_futex(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4, execenv->regs.__syscall_rarg5);
	...
	case SYS_set_tid_address:
		...
		ret = uk_syscall_do_e_set_tid_address((long)execenv);
#else /* !HAVE_uk_syscall_e_set_tid_address */
		ret = uk_syscall_do_set_tid_address(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_getuid:
		...
		ret = uk_syscall_do_e_getuid((long)execenv);
#else /* !HAVE_uk_syscall_e_getuid */
		ret = uk_syscall_do_getuid(
					);
	...
	case SYS_setuid:
		...
		ret = uk_syscall_do_e_setuid((long)execenv);
#else /* !HAVE_uk_syscall_e_setuid */
		ret = uk_syscall_do_setuid(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_geteuid:
		...
		ret = uk_syscall_do_e_geteuid((long)execenv);
#else /* !HAVE_uk_syscall_e_geteuid */
		ret = uk_syscall_do_geteuid(
					);
	...
	case SYS_setreuid:
		...
		ret = uk_syscall_do_e_setreuid((long)execenv);
#else /* !HAVE_uk_syscall_e_setreuid */
		ret = uk_syscall_do_setreuid(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_getresuid:
		...
		ret = uk_syscall_do_e_getresuid((long)execenv);
#else /* !HAVE_uk_syscall_e_getresuid */
		ret = uk_syscall_do_getresuid(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_setresuid:
		...
		ret = uk_syscall_do_e_setresuid((long)execenv);
#else /* !HAVE_uk_syscall_e_setresuid */
		ret = uk_syscall_do_setresuid(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_setfsuid:
		...
		ret = uk_syscall_do_e_setfsuid((long)execenv);
#else /* !HAVE_uk_syscall_e_setfsuid */
		ret = uk_syscall_do_setfsuid(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_getgid:
		...
		ret = uk_syscall_do_e_getgid((long)execenv);
#else /* !HAVE_uk_syscall_e_getgid */
		ret = uk_syscall_do_getgid(
					);
	...
	case SYS_setgid:
		...
		ret = uk_syscall_do_e_setgid((long)execenv);
#else /* !HAVE_uk_syscall_e_setgid */
		ret = uk_syscall_do_setgid(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_getegid:
		...
		ret = uk_syscall_do_e_getegid((long)execenv);
#else /* !HAVE_uk_syscall_e_getegid */
		ret = uk_syscall_do_getegid(
					);
	...
	case SYS_setregid:
		...
		ret = uk_syscall_do_e_setregid((long)execenv);
#else /* !HAVE_uk_syscall_e_setregid */
		ret = uk_syscall_do_setregid(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_getresgid:
		...
		ret = uk_syscall_do_e_getresgid((long)execenv);
#else /* !HAVE_uk_syscall_e_getresgid */
		ret = uk_syscall_do_getresgid(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_setresgid:
		...
		ret = uk_syscall_do_e_setresgid((long)execenv);
#else /* !HAVE_uk_syscall_e_setresgid */
		ret = uk_syscall_do_setresgid(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_setfsgid:
		...
		ret = uk_syscall_do_e_setfsgid((long)execenv);
#else /* !HAVE_uk_syscall_e_setfsgid */
		ret = uk_syscall_do_setfsgid(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_getgroups:
		...
		ret = uk_syscall_do_e_getgroups((long)execenv);
#else /* !HAVE_uk_syscall_e_getgroups */
		ret = uk_syscall_do_getgroups(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_setgroups:
		...
		ret = uk_syscall_do_e_setgroups((long)execenv);
#else /* !HAVE_uk_syscall_e_setgroups */
		ret = uk_syscall_do_setgroups(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_capget:
		...
		ret = uk_syscall_do_e_capget((long)execenv);
#else /* !HAVE_uk_syscall_e_capget */
		ret = uk_syscall_do_capget(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_capset:
		...
		ret = uk_syscall_do_e_capset((long)execenv);
#else /* !HAVE_uk_syscall_e_capset */
		ret = uk_syscall_do_capset(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_mmap:
		...
		ret = uk_syscall_do_e_mmap((long)execenv);
#else /* !HAVE_uk_syscall_e_mmap */
		ret = uk_syscall_do_mmap(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4, execenv->regs.__syscall_rarg5);
	...
	case SYS_munmap:
		...
		ret = uk_syscall_do_e_munmap((long)execenv);
#else /* !HAVE_uk_syscall_e_munmap */
		ret = uk_syscall_do_munmap(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_madvise:
		...
		ret = uk_syscall_do_e_madvise((long)execenv);
#else /* !HAVE_uk_syscall_e_madvise */
		ret = uk_syscall_do_madvise(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_mremap:
		...
		ret = uk_syscall_do_e_mremap((long)execenv);
#else /* !HAVE_uk_syscall_e_mremap */
		ret = uk_syscall_do_mremap(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_mprotect:
		...
		ret = uk_syscall_do_e_mprotect((long)execenv);
#else /* !HAVE_uk_syscall_e_mprotect */
		ret = uk_syscall_do_mprotect(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_sched_yield:
		...
		ret = uk_syscall_do_e_sched_yield((long)execenv);
#else /* !HAVE_uk_syscall_e_sched_yield */
		ret = uk_syscall_do_sched_yield(
					);
	...
	case SYS_sched_getaffinity:
		...
		ret = uk_syscall_do_e_sched_getaffinity((long)execenv);
#else /* !HAVE_uk_syscall_e_sched_getaffinity */
		ret = uk_syscall_do_sched_getaffinity(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_sched_setaffinity:
		...
		ret = uk_syscall_do_e_sched_setaffinity((long)execenv);
#else /* !HAVE_uk_syscall_e_sched_setaffinity */
		ret = uk_syscall_do_sched_setaffinity(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_membarrier:
		...
		ret = uk_syscall_do_e_membarrier((long)execenv);
#else /* !HAVE_uk_syscall_e_membarrier */
		ret = uk_syscall_do_membarrier(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
...
#ifdef HAVE_uk_syscall_e_getrandom
		ret = uk_syscall_do_e_getrandom((long)execenv);
#else /* !HAVE_uk_syscall_e_getrandom */
		ret = uk_syscall_do_getrandom(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_nanosleep:
		...
		ret = uk_syscall_do_e_nanosleep((long)execenv);
#else /* !HAVE_uk_syscall_e_nanosleep */
		ret = uk_syscall_do_nanosleep(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_clock_getres:
		...
		ret = uk_syscall_do_e_clock_getres((long)execenv);
#else /* !HAVE_uk_syscall_e_clock_getres */
		ret = uk_syscall_do_clock_getres(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_clock_gettime:
		...
		ret = uk_syscall_do_e_clock_gettime((long)execenv);
#else /* !HAVE_uk_syscall_e_clock_gettime */
		ret = uk_syscall_do_clock_gettime(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_clock_settime:
		...
		ret = uk_syscall_do_e_clock_settime((long)execenv);
#else /* !HAVE_uk_syscall_e_clock_settime */
		ret = uk_syscall_do_clock_settime(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_clock_nanosleep:
		...
		ret = uk_syscall_do_e_clock_nanosleep((long)execenv);
#else /* !HAVE_uk_syscall_e_clock_nanosleep */
		ret = uk_syscall_do_clock_nanosleep(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_gettimeofday:
		...
		ret = uk_syscall_do_e_gettimeofday((long)execenv);
#else /* !HAVE_uk_syscall_e_gettimeofday */
		ret = uk_syscall_do_gettimeofday(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_settimeofday:
		...
		ret = uk_syscall_do_e_settimeofday((long)execenv);
#else /* !HAVE_uk_syscall_e_settimeofday */
		ret = uk_syscall_do_settimeofday(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_times:
		...
		ret = uk_syscall_do_e_times((long)execenv);
#else /* !HAVE_uk_syscall_e_times */
		ret = uk_syscall_do_times(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_time:
		...
		ret = uk_syscall_do_e_time((long)execenv);
#else /* !HAVE_uk_syscall_e_time */
		ret = uk_syscall_do_time(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_setitimer:
		...
		ret = uk_syscall_do_e_setitimer((long)execenv);
#else /* !HAVE_uk_syscall_e_setitimer */
		ret = uk_syscall_do_setitimer(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_timer_create:
		...
		ret = uk_syscall_do_e_timer_create((long)execenv);
#else /* !HAVE_uk_syscall_e_timer_create */
		ret = uk_syscall_do_timer_create(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_timer_delete:
		...
		ret = uk_syscall_do_e_timer_delete((long)execenv);
#else /* !HAVE_uk_syscall_e_timer_delete */
		ret = uk_syscall_do_timer_delete(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_timer_settime:
		...
		ret = uk_syscall_do_e_timer_settime((long)execenv);
#else /* !HAVE_uk_syscall_e_timer_settime */
		ret = uk_syscall_do_timer_settime(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_timer_gettime:
		...
		ret = uk_syscall_do_e_timer_gettime((long)execenv);
#else /* !HAVE_uk_syscall_e_timer_gettime */
		ret = uk_syscall_do_timer_gettime(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_timer_getoverrun:
		...
		ret = uk_syscall_do_e_timer_getoverrun((long)execenv);
#else /* !HAVE_uk_syscall_e_timer_getoverrun */
		ret = uk_syscall_do_timer_getoverrun(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_readlink:
		...
		ret = uk_syscall_do_e_readlink((long)execenv);
#else /* !HAVE_uk_syscall_e_readlink */
		ret = uk_syscall_do_readlink(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_link:
		...
		ret = uk_syscall_do_e_link((long)execenv);
#else /* !HAVE_uk_syscall_e_link */
		ret = uk_syscall_do_link(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_truncate:
		...
		ret = uk_syscall_do_e_truncate((long)execenv);
#else /* !HAVE_uk_syscall_e_truncate */
		ret = uk_syscall_do_truncate(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_access:
		...
		ret = uk_syscall_do_e_access((long)execenv);
#else /* !HAVE_uk_syscall_e_access */
		ret = uk_syscall_do_access(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_faccessat:
		...
		ret = uk_syscall_do_e_faccessat((long)execenv);
#else /* !HAVE_uk_syscall_e_faccessat */
		ret = uk_syscall_do_faccessat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_chdir:
		...
		ret = uk_syscall_do_e_chdir((long)execenv);
#else /* !HAVE_uk_syscall_e_chdir */
		ret = uk_syscall_do_chdir(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_fchdir:
		...
		ret = uk_syscall_do_e_fchdir((long)execenv);
#else /* !HAVE_uk_syscall_e_fchdir */
		ret = uk_syscall_do_fchdir(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_chmod:
		...
		ret = uk_syscall_do_e_chmod((long)execenv);
#else /* !HAVE_uk_syscall_e_chmod */
		ret = uk_syscall_do_chmod(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_utime:
		...
		ret = uk_syscall_do_e_utime((long)execenv);
#else /* !HAVE_uk_syscall_e_utime */
		ret = uk_syscall_do_utime(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_utimes:
		...
		ret = uk_syscall_do_e_utimes((long)execenv);
#else /* !HAVE_uk_syscall_e_utimes */
		ret = uk_syscall_do_utimes(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_mknod:
		...
		ret = uk_syscall_do_e_mknod((long)execenv);
#else /* !HAVE_uk_syscall_e_mknod */
		ret = uk_syscall_do_mknod(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_rmdir:
		...
		ret = uk_syscall_do_e_rmdir((long)execenv);
#else /* !HAVE_uk_syscall_e_rmdir */
		ret = uk_syscall_do_rmdir(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_rename:
		...
		ret = uk_syscall_do_e_rename((long)execenv);
#else /* !HAVE_uk_syscall_e_rename */
		ret = uk_syscall_do_rename(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_renameat:
		...
		ret = uk_syscall_do_e_renameat((long)execenv);
#else /* !HAVE_uk_syscall_e_renameat */
		ret = uk_syscall_do_renameat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_umask:
		...
		ret = uk_syscall_do_e_umask((long)execenv);
#else /* !HAVE_uk_syscall_e_umask */
		ret = uk_syscall_do_umask(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_lstat:
		...
		ret = uk_syscall_do_e_lstat((long)execenv);
#else /* !HAVE_uk_syscall_e_lstat */
		ret = uk_syscall_do_lstat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_flock:
		...
		ret = uk_syscall_do_e_flock((long)execenv);
#else /* !HAVE_uk_syscall_e_flock */
		ret = uk_syscall_do_flock(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_getcwd:
		...
		ret = uk_syscall_do_e_getcwd((long)execenv);
#else /* !HAVE_uk_syscall_e_getcwd */
		ret = uk_syscall_do_getcwd(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_utimensat:
		...
		ret = uk_syscall_do_e_utimensat((long)execenv);
#else /* !HAVE_uk_syscall_e_utimensat */
		ret = uk_syscall_do_utimensat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_futimesat:
		...
		ret = uk_syscall_do_e_futimesat((long)execenv);
#else /* !HAVE_uk_syscall_e_futimesat */
		ret = uk_syscall_do_futimesat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_sync:
		...
		ret = uk_syscall_do_e_sync((long)execenv);
#else /* !HAVE_uk_syscall_e_sync */
		ret = uk_syscall_do_sync(
					);
	...
	case SYS_mount:
		...
		ret = uk_syscall_do_e_mount((long)execenv);
#else /* !HAVE_uk_syscall_e_mount */
		ret = uk_syscall_do_mount(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3, execenv->regs.__syscall_rarg4);
	...
	case SYS_statfs:
		...
		ret = uk_syscall_do_e_statfs((long)execenv);
#else /* !HAVE_uk_syscall_e_statfs */
		ret = uk_syscall_do_statfs(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_fstatfs:
		...
		ret = uk_syscall_do_e_fstatfs((long)execenv);
#else /* !HAVE_uk_syscall_e_fstatfs */
		ret = uk_syscall_do_fstatfs(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_lchown:
		...
		ret = uk_syscall_do_e_lchown((long)execenv);
#else /* !HAVE_uk_syscall_e_lchown */
		ret = uk_syscall_do_lchown(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_chown:
		...
		ret = uk_syscall_do_e_chown((long)execenv);
#else /* !HAVE_uk_syscall_e_chown */
		ret = uk_syscall_do_chown(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_stat:
		...
		ret = uk_syscall_do_e_stat((long)execenv);
#else /* !HAVE_uk_syscall_e_stat */
		ret = uk_syscall_do_stat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_mkdir:
		...
		ret = uk_syscall_do_e_mkdir((long)execenv);
#else /* !HAVE_uk_syscall_e_mkdir */
		ret = uk_syscall_do_mkdir(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_mkdirat:
		...
		ret = uk_syscall_do_e_mkdirat((long)execenv);
#else /* !HAVE_uk_syscall_e_mkdirat */
		ret = uk_syscall_do_mkdirat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_umount2:
		...
		ret = uk_syscall_do_e_umount2((long)execenv);
#else /* !HAVE_uk_syscall_e_umount2 */
		ret = uk_syscall_do_umount2(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_symlink:
		...
		ret = uk_syscall_do_e_symlink((long)execenv);
#else /* !HAVE_uk_syscall_e_symlink */
		ret = uk_syscall_do_symlink(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_unlink:
		...
		ret = uk_syscall_do_e_unlink((long)execenv);
#else /* !HAVE_uk_syscall_e_unlink */
		ret = uk_syscall_do_unlink(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_unlinkat:
		...
		ret = uk_syscall_do_e_unlinkat((long)execenv);
#else /* !HAVE_uk_syscall_e_unlinkat */
		ret = uk_syscall_do_unlinkat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_chroot:
		...
		ret = uk_syscall_do_e_chroot((long)execenv);
#else /* !HAVE_uk_syscall_e_chroot */
		ret = uk_syscall_do_chroot(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_getdents64:
		...
		ret = uk_syscall_do_e_getdents64((long)execenv);
#else /* !HAVE_uk_syscall_e_getdents64 */
		ret = uk_syscall_do_getdents64(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_newfstatat:
		...
		ret = uk_syscall_do_e_newfstatat((long)execenv);
#else /* !HAVE_uk_syscall_e_newfstatat */
		ret = uk_syscall_do_newfstatat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_open:
		...
		ret = uk_syscall_do_e_open((long)execenv);
#else /* !HAVE_uk_syscall_e_open */
		ret = uk_syscall_do_open(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_openat:
		...
		ret = uk_syscall_do_e_openat((long)execenv);
#else /* !HAVE_uk_syscall_e_openat */
		ret = uk_syscall_do_openat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2, execenv->regs.__syscall_rarg3);
	...
	case SYS_creat:
		...
		ret = uk_syscall_do_e_creat((long)execenv);
#else /* !HAVE_uk_syscall_e_creat */
		ret = uk_syscall_do_creat(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);

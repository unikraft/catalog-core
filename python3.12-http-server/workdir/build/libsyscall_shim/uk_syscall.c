...
long uk_vsyscall(long nr, va_list arg __maybe_unused)
{
	...
	case SYS_eventfd2:
		a1 = va_arg(arg, long);
		a2 = va_arg(arg, long);
		ret = uk_syscall_e_eventfd2(a1, a2);
		break;
	...
	case SYS_sethostname:
		a1 = va_arg(arg, long);
		a2 = va_arg(arg, long);
		ret = uk_syscall_e_sethostname(a1, a2);
		break;
	...
	case SYS_getcpu:
		...
		a2 = va_arg(arg, long);
		a3 = va_arg(arg, long);
		ret = uk_syscall_e_getcpu(a1, a2, a3);
		break;

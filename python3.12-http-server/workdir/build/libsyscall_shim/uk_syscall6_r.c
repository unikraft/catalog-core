...
long __used uk_syscall6_r_e(struct ukarch_execenv *execenv)
{
	...
	case SYS_eventfd:
		...
		ret = uk_syscall_r_e_eventfd((long)execenv);
#else /* !HAVE_uk_syscall_e_eventfd */
		ret = uk_syscall_r_eventfd(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_eventfd2:
		...
		ret = uk_syscall_r_e_eventfd2((long)execenv);
#else /* !HAVE_uk_syscall_e_eventfd2 */
		ret = uk_syscall_r_eventfd2(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_sysinfo:
		...
		ret = uk_syscall_r_e_sysinfo((long)execenv);
#else /* !HAVE_uk_syscall_e_sysinfo */
		ret = uk_syscall_r_sysinfo(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_uname:
		...
		ret = uk_syscall_r_e_uname((long)execenv);
#else /* !HAVE_uk_syscall_e_uname */
		ret = uk_syscall_r_uname(
					execenv->regs.__syscall_rarg0);
	...
	case SYS_sethostname:
		...
		ret = uk_syscall_r_e_sethostname((long)execenv);
#else /* !HAVE_uk_syscall_e_sethostname */
		ret = uk_syscall_r_sethostname(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1);
	...
	case SYS_getcpu:
		...
		ret = uk_syscall_r_e_getcpu((long)execenv);
#else /* !HAVE_uk_syscall_e_getcpu */
		ret = uk_syscall_r_getcpu(
					execenv->regs.__syscall_rarg0, execenv->regs.__syscall_rarg1, execenv->regs.__syscall_rarg2);
	...
	case SYS_getrandom:
		...
		ret = uk_syscall_r_e_getrandom((long)execenv);

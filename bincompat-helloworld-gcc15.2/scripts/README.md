# Scripts for Bincompat-helloworld-gcc15.2 on Unikraft

These are companions instruction to the main instructions in the [`README`](README.md).

Use scripts as quick actions for building and running the bincompat helloworld gcc application on Unikraft:
